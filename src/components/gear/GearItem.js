export const GearItem = ({ gearItemObject }) => {
    ...
    return <section className="gearItemObject h-[150px] w-[550px] py-8 px-8 max-w-sm mx-auto rounded-xl shadow-lg shadow-orange-300 space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6" key={gearItemObject.id}>
